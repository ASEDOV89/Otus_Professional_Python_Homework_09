import pandas as pd
import numpy as np
from forecasting import preprocess_item_data, train_item_model, forecast_item_sales
...
def test_train_and_forecast():
    ...
    forecast_days = 5
    forecast = forecast_item_sales(model, scaler, data, forecast_days, features)
